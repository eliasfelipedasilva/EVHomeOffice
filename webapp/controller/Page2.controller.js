sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.vai.controller.Page2", {
	...
	_onChangeSlider: function(oEvent){
		...
		_onToggleButtonPress: function(oEvent) {
			...
			localStorage.setItem("resposta1", Resp1);
			localStorage.setItem("name", this.getView().byId("label1").getText());
			localStorage.setItem("lastName", this.getView().byId("label2").getText());
			/*
			var test = false;
			$.ajax({
				...
				"data": JSON.stringify({
					...
					"cust_name": this.getView().byId("label1").getText(),
					"cust_lastName": this.getView().byId("label2").getText(),
		...
		onInit: function() {
			...
			this.oRouter.getRoute("Page2").attachMatched(this._onRouteMatched, this);
