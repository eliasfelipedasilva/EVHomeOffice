sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.vai.controller.Page3", {
...
_onToggleButtonPress: function(oEvent) {
			...
			localStorage.setItem("resposta2", Resp1);
			/*
			var test = false;
			$.ajax({
		...
		onInit: function() {
			...
			this.oRouter.getRoute("Page3").attachMatched(this._onRouteMatched, this);
